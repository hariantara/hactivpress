<template lang="html">
  <div class="container posisilogin">
    <div class="row">
            ...
            <div class="login-box well">
                    <form @submit.prevent="signinForm()">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="signinData.username" id="username-email" placeholder="Username" type="text" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="password">Password</label>
                            <input id="password" v-model="signinData.password" placeholder="Password" type="password" class="form-control" />
                        </div>
